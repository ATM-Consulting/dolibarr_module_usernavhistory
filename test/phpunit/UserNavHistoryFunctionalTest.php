...
/**
 * \file    test/phpunit/UserNavHistoryFunctionalTest.php
...
/**
 * Class UserNavHistoryFunctionalTest
 *
 ...
 *
 * @package Testusernavhistory
 */
class UserNavHistoryFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modUserNavHistory')->click();
		} else {
			// Disable the module
			$this->byHref('modUserNavHistory')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/usernavhistory/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('usernavhistory/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/usernavhistory/admin/about.php');
		$this->authenticate();
		return $this->assertContains('usernavhistory/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('usernavhistorywidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modUserNavHistory_UserNavHistoryTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modUserNavHistory_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
